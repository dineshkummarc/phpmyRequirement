        ...
        if ($this->page == 1) {
            ...
            if ($this->header_xobjid === false) {
                ...
                if (($headerdata['logo']) AND ($headerdata['logo'] != K_BLANK_IMAGE)) {
                    $imgtype = TCPDF_IMAGES::getImageFileType(FCPATH.'assets/images/'.$headerdata['logo']);
                    if (($imgtype == 'eps') OR ($imgtype == 'ai')) {
                        $this->ImageEps(FCPATH.'assets/images/'.$headerdata['logo'], '', '', $headerdata['logo_width']);
                    } elseif ($imgtype == 'svg') {
                        $this->ImageSVG(FCPATH.'assets/images/'.$headerdata['logo'], '', '', $headerdata['logo_width']);
                    } else {
                        $this->Image(FCPATH.'assets/images/'.$headerdata['logo'], '', '', $headerdata['logo_width']);
                    }
